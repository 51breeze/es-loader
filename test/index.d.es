...
package web.ui{
    ...
    @Require(Select = "element-ui/packages/select")
    ...
    class MySelectOption extends SelectOption{
        @Override
        render(){
            return <div>ssssssss<SelectOption {...this.data()}/></div>
        }
    }

    @Require(Notification = "element-ui/packages/notification")
    @Embed('element-ui/lib/theme-chalk/notification.css');
    @Embed('element-ui/lib/theme-chalk/icon.css');
    declare class Notification extends web.components.Component{
        @Callable
